<template>
    ...
    <van-button class="min" type="primary" block @click="update"
        >更新</van-button
    >
</template>
...
import { dingTalkLogin } from "../api/common";
export default {
    setup() {
        ...
        const update = () => {
            ...
            dingTalkLogin({ code: "TestTeacher" }).then((res) => {
                // TestStudent   TestTeacher
                console.log(res);
            });
        };
        return {
